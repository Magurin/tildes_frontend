...
export async function POST(request: Request) {
  ...
  const system = [
    ...
    "без кавычек, без транскрипции, без вариантов. Если части фразы нет в",
    "словаре, переведи по грамматическим правилам ниже, опираясь на known",
    "словарь и примеры. Слово, которого нет и которое нельзя построить,",
    "оставь как есть и помечать не нужно.",
    "",
    grammar,
    "",
